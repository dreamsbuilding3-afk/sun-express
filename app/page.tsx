...
import { ArrowRight, LockKeyhole, PackageCheck, Search, UserRound } from "lucide-react";
        ...
        <div className="mx-auto max-w-6xl">
          <div className="max-w-3xl">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Link href="/suivi" className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#D9C8BA] bg-white px-5 py-3.5 font-bold text-se-primaire hover:bg-se-carte"><Search size={18}/> Suivre une expédition</Link>
            </div>
          </div>
          ...
          <div className="mt-14 grid gap-4 md:grid-cols-3">
            ...
            <Feature icon={<LockKeyhole size={20}/>} title="Suivi sécurisé" text="Retrouvez l'avancement de votre demande avec votre bordereau et votre téléphone." />
          </div>
        </div>
      </section>
