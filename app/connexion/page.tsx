  ...
  async function submit(event: FormEvent) {
    ...
    try {
      ...
      if (mode === "signup") {
        ...
        router.push(profile?.role === "admin" ? "/gerante" : "/client");
      }
    } catch (error) {
